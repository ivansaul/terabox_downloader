...
def download(url:str, download_path:str) -> bool:
    command = ['aria2c', '--conf-path', 'aria2.conf', '--dir', download_path, url]
...
def mkdir_path(path: str) -> None:
    """
    Create a new directory and any intermediate directories in the given path.
